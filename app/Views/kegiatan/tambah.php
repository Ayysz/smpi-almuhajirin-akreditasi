<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-plus-circle"></i> Tambah Kegiatan Baru</h2>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            ...
            <form action="<?= base_url('kegiatan/simpan') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="jenis_kegiatan" id="jenis_kegiatan" required onchange="toggleFileFields()">
                                ...
                                <option value="KARAKTER" <?= old('jenis_kegiatan') == 'KARAKTER' ? 'selected' : '' ?>>Karakter / Pembinaan Karakter</option>
                                <option value="KEAGAMAAN" <?= old('jenis_kegiatan') == 'KEAGAMAAN' ? 'selected' : '' ?>>Keagamaan</option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="tempat" value="<?= old('tempat') ?>" placeholder="Contoh: Aula Sekolah" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Tahun Ajaran <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="tahun_ajaran" value="<?= old('tahun_ajaran') ?>" placeholder="Contoh: 2024/2025" required>
                        </div>
                    </div>
                </div>
                ...
                <hr class="my-4">
                <h5 class="mb-3"><i class="bi bi-paperclip"></i> Dokumen Upload</h5>

                <div id="file-fields">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" id="label-absensi">File Absensi <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="foto_kegiatan" id="foto_kegiatan" accept=".jpg,.jpeg,.png,.pdf">
                                <small class="text-muted">Format: PDF, JPG, PNG. Maks: 5MB</small>
                            </div>
                        </div>
                    </div>
...
function toggleFileFields() {
    ...
    // Default required for Absensi & Foto (except LAINNYA)
    if (jenis !== 'LAINNYA') {
        document.getElementById('file_absensi').setAttribute('required', 'required');
        document.getElementById('foto_kegiatan').setAttribute('required', 'required');
    }
    ...
    if (jenis === 'KARAKTER') {
        ...
        document.getElementById('rundown_kegiatan').setAttribute('required', 'required');
        
        if (reqRundown) reqRundown.style.display = 'inline';
        ...
        document.getElementById('rundown_kegiatan').setAttribute('required', 'required');
        document.getElementById('surat_keterangan').setAttribute('required', 'required');
        
        if (reqRundown) reqRundown.style.display = 'inline';
        if (reqSk) reqSk.style.display = 'inline';
